	...
	<section class="padding container" id="section-1">
		...
		<form  enctype="multipart/form-data" method="post">
            ...
            if(isset($_POST['updatebtn']))
            {
                ...
                $id=$_SESSION["ID"];
                //////
                $filename = $_FILES['nphoto']["name"];
                $ext=$_=pathinfo($filename, PATHINFO_EXTENSION);;
               
   				$tempfile = $_FILES["nphoto"]["tmp_name"];
   				$filenameWithDirectory = "profilepics_upload/".basename($tempfile).".$ext";
                ...
                $sql=mysqli_query($con,"UPDATE `users` SET `fname`='$nfname',`lname`='$nlname',`photo`='$short_name',`username`='$nusername',`major`='$nmajor',`interests`='$ninterests' WHERE sid='$id' ");
