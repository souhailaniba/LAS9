...
<body>
		...
		<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navmenu">
						<ul class="navbar-nav mx-auto ">
							...
							<li class="nav-padding  nav-item"><a href="-%20recherche.php" class="nav-link">Les LAS9s</a></li>
							
							<li class="nav-padding active nav-item"><a href="-%20profile.php" class="active nav-link">Mon profile</a></li>
							<li class="nav-padding  nav-item"><a href="-%20editprofile.php" class=" nav-link">Edit Profile</a></li>

							<li class="nav-padding  nav-item d-none"id="toshowbutton" ><a  class="nav-link  text-nowrap "  href="-%20index.php">Deconnexion </a></li>
	...
	<section class="padding container-fluid row" id="section-1">
		<div class="col-sm-12 col-md-3">
			<div class="row ">			
				<div class="d-flex align-content-center  col-sm-12 ">
					<img class="img-fluid  image-profile-div image-profile" src="img/banner.jpg" alt="...">
				</div>
			<div class="col-5  ">
				<p class="img-fluid lead "  alt="...">Name </p>
				<p class="img-fluid "  alt="...">Major: <span class="lead">sasasa </span></p>
				<p class="img-fluid "  alt="...">Interests:<span class="lead">sasasa </span> </p>
			</div>
			</div>
		...
		<div class="row">
			<div class="col-md-8"><h2>Vos Fichiers</h2></div>
			
		</div>
		
			<div class="card row h-auto">
  <div class="card-body">
  	<div class="row">
  		<div class="col-9">
    ...
    <p class="card-text">Année: </p>
    <p class="card-text">Niveau</p>
