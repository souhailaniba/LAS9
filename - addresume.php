		...
		<h2>Add</h2>
		 <form method="post">
					...
					<select name="type" class="form-select">
						<option value="IAGI">TD</option>
						<option value="MSEI">Resume</option>
						<option value="GEM">Examen</option>
						<option value="GM">Controle</option>
            ...
            if(isset($_POST['uploadbtn']))
            {
                ...
                $sql=mysqli_query($con,"INSERT INTO `files`(`titre`,`type`,`major`,`annee`,`fichier`,`commentaire`) VALUES('$titre','$type','$major','$annee','$fichier','$commentaire')");
                if($sql==true)
                {
                    echo '
                            <script>
