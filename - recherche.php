        ...
        <?php while($row = mysqli_fetch_array($search_result)):?>
			<div class="card row h-auto">
                <div class="card-body">
  	                <div class="row">
  		                <div class="col-9">
                            <h5 class="card-title "><?php echo $row['matiere']; ?></h5></div>
                            <div class="col-3">
                                <a href=""><i class="bi bi-trash-fill"></i></a>
                                <a href="-%20addresume.php"><i class="bi bi-pencil-square"></i></a>
                            </div>
                        </div>
                    <p class="card-text">Niveau: <?php echo $row['niveau']; ?></p>
                    <p class="card-text">Filière: <?php echo $row['filiere']; ?></p>
                    <p class="card-text">Prix: <?php echo $row['prix']; ?></p>
                    <p class="card-text">Uploaded By: <?php  echo $row['firstname'] . ' ' . $row['lastname']; ?></p>
