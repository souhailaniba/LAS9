    ...
    <div class="  vh-sm-200 vh-md-100 row">
        <div class=" padding col-md-6 col-sm-12">
            ...
            <form method="post">
                ...
                <input name="nuser" type="email" class="form-control" placeholder="name@example.com" value="<?php echo $result['username']; ?>">
            ...
            if(isset($_POST['updatebtn']))
            {
                ...
                $sql=mysqli_query($con,"UPDATE `users` SET `fname`='$nfname',`lname`='$nlname',`username`='$nuser',`major`='$nmajor',`interests`='$ninterests',`photo`='$nphoto' WHERE sid='$sid' ");
                if($sql == true)
                {
                    echo '
                            <script>
